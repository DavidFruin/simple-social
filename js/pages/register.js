...
const RegisterPage = {
      ...
      <div class="page-container">
        <div class="form-card">
          ...
          <div id="step-3" class="register-step hidden">
            <p class="step-info">Set your password</p>
  ...
  async handleOTPSubmit(e) {
    ...
    try {
      await api.verifyRegisterOTP(this.email, otp);
  ...
  async handleResendOTP() {
    ...
    try {
      await api.sendRegisterOTP(this.email);
  ...
  async handlePasswordSubmit(e) {
    ...
    try {
      await api.finishRegister(this.email, password, confirm);
